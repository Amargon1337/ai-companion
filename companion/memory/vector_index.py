...
class VectorIndex:
    ...
    def _rebuild_index(self) -> None:
        # Full rebuild replaces self.index; must hold the same lock as
        # upsert_embedding / delete_for_content / save_index_to_disk to avoid
        # racing concurrent writes against a half-rebuilt index.
        with self._locked():
