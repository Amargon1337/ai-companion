...
def get_main_keyboard():
    ...
    for btn in ["/search", "/summary", "/personality", "/remember", "/help"]:
        builder.button(text=btn)
    builder.adjust(3, 2)
    return builder.as_markup(resize_keyboard=True, placeholder="Напиши сообщение или выбери действие...")
...
def register(dp, bot) -> None:
    ...
    async def cmd_help(message: types.Message):
        ...
        await message.answer(txt, parse_mode="HTML", reply_markup=get_main_keyboard())
